...
import { Volume2, VolumeX, Radio, Palette } from 'lucide-react';
...
const ACCENT_COLORS = [
  ...
  { id: 'green', name: 'Verde', hex: '#00FF66', bg: 'bg-[#00FF66]', glow: 'shadow-[0_0_12px_rgba(255,255,255,0.7)]' },
  ...
  return (
    <div className="w-full bg-[#0D0D0D] border border-white/10 p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-2.5 bg-white/5 border border-white/5 p-3 flex flex-col justify-center">
        ...
        {/* 2. Ajuste do Timbre Selecionado */}
        <div className="bg-white/5 border border-white/5 p-3 flex flex-col justify-center">
          <div className="space-y-2">
            <span className="text-[10px] font-mono text-white/40 block uppercase tracking-widest">Onda do Oscilador</span>
        ...
        {/* 3. Seletor de Tema de Cores (Design Conforme Requisitado) */}
        <div className="space-y-2.5 bg-white/5 border border-white/5 p-3 flex flex-col justify-center">
